...
ConversorTemperatura.java: Conversão de Celsius para Fahrenheit e vice-versa.

CalculoIMC.java: Cálculo de Índice de Massa Corporal.

estruturas-controle/: (Em breve) Exercícios com if/else, switch e loops.
